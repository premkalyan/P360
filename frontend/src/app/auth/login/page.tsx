...
// Figma assets from node 758:7457
...
export default function LoginPage() {
  ...
  return (
    <div className="bg-white relative size-full" style={{ fontFamily: "'Lexend Deca', sans-serif" }}>
      ...
      {/* Pipeline360 Logo - Exact Figma positioning */}
      ...
      <div className="absolute left-1/2 max-w-[768px] rounded-[4px] translate-x-[-50%] translate-y-[-50%] w-[768px]" style={{ top: "calc(50% - 16px)" }}>
        <div className="content-stretch flex items-center justify-between max-w-inherit overflow-clip relative w-[768px]">
          ...
          <div className="basis-0 bg-white box-border content-stretch flex flex-col gap-4 grow items-start justify-start min-h-px min-w-px p-[32px] relative shrink-0">
            <div className="content-stretch flex flex-col gap-6 items-center justify-center relative rounded-[8px] shrink-0 w-full">
              ...
              <div className="content-stretch flex flex-col gap-2 items-start justify-start leading-[0] relative shrink-0 w-full">
                <div className="font-semibold relative shrink-0 text-[#101828] text-[24px] tracking-[-0.4px] w-full" style={{ fontFamily: "'Lexend Deca', sans-serif", lineHeight: "30px" }}>
                  Welcome back
                </div>
                <div className="font-normal relative shrink-0 text-[#4a5565] text-[14px] w-full" style={{ fontFamily: "'Lexend Deca', sans-serif", lineHeight: "20px" }}>
              ...
              <form onSubmit={handleLogin} className="content-stretch flex flex-col gap-6 items-start justify-start relative shrink-0 w-full">
                ...
                <div className="content-stretch flex flex-col gap-2 items-start justify-start relative shrink-0 w-80">
                  <div className="content-stretch flex gap-1 items-start justify-start leading-[0] relative shrink-0 text-[14px] text-nowrap w-full" style={{ fontFamily: "'Lexend Deca', sans-serif" }}>
                  ...
                  <div className="bg-white box-border content-stretch flex gap-0.5 h-10 items-center justify-start px-2.5 py-0 relative rounded-[4px] shrink-0 w-full">
                    <div aria-hidden="true" className={`absolute border border-solid inset-[-1px] pointer-events-none rounded-[5px] ${
                      errors.email ? 'border-[#f00250]' : 'border-[#e5e7eb]'
                    }`} />
                    <div className="basis-0 box-border content-stretch flex grow items-start justify-start min-h-px min-w-px px-1.5 py-0 relative shrink-0">
                      <input
                        ...
                        className="font-normal leading-[0] text-[14px] w-full bg-transparent border-none outline-none text-[#101828] placeholder:text-[#99a1af]"
                        style={{ fontFamily: "'Lexend Deca', sans-serif", lineHeight: "20px" }}
                        disabled={isLoading}
                      />
                    </div>
                  </div>
                  {errors.email && (
                    <div className="font-normal leading-[0] relative shrink-0 text-[#f00250] text-[12px] text-nowrap" style={{ fontFamily: "'Lexend Deca', sans-serif", lineHeight: "16px" }}>
                      {errors.email}
                    </div>
                  )}
                </div>
                ...
                <div className="content-stretch flex flex-col gap-2 items-start justify-start relative shrink-0 w-80">
                  ...
                  <div className="bg-white box-border content-stretch flex gap-0.5 h-10 items-center justify-start px-2.5 py-0 relative rounded-[4px] shrink-0 w-full">
                    <div aria-hidden="true" className={`absolute border border-solid inset-[-1px] pointer-events-none rounded-[5px] ${
                      errors.password ? 'border-[#f00250]' : 'border-[#e5e7eb]'
                    }`} />
                    <div className="basis-0 box-border content-stretch flex grow items-start justify-start min-h-px min-w-px px-1.5 py-0 relative shrink-0">
                      <input
                        type="password"
                ...
                >
                  {isLoading ? (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-normal leading-[0] text-[14px]" style={{ fontFamily: "'Lexend Deca', sans-serif", lineHeight: "20px" }}>
                        Logging in...
                      </span>
                    </div>
                  ) : (
                    <div className="font-normal leading-[0] relative shrink-0 text-[14px] text-nowrap" style={{ fontFamily: "'Lexend Deca', sans-serif", lineHeight: "20px" }}>
                      Login
                    </div>
                  )}
                </button>
                ...
                <div className="box-border content-stretch flex flex-col gap-2.5 items-start justify-start px-0 py-2.5 relative shrink-0 w-full">
                  ...
                  <div className="absolute bg-white box-border content-stretch flex items-center justify-center px-2 py-0 top-1/2 translate-x-[-50%] translate-y-[-50%]" style={{ left: "calc(50% - 0.5px)" }}>
                    <div className="font-normal leading-[0] relative shrink-0 text-[12px] text-nowrap text-[#71717a]" style={{ fontFamily: "'Lexend Deca', sans-serif", lineHeight: "16px" }}>
                      Or continue with
                    </div>
                  </div>
                </div>
                ...
                <div className="content-stretch flex flex-col gap-2.5 items-center justify-start relative shrink-0 w-full">
                  ...
                  >
                    ...
                    <div className="font-normal leading-[0] relative shrink-0 text-[#101828] text-[14px] text-nowrap" style={{ fontFamily: "'Lexend Deca', sans-serif", lineHeight: "20px" }}>
                      Login with Google
                    </div>
                  </button>
          ...
          {/* Right Panel - Background Image (384px) */}
        ...
        <div aria-hidden="true" className="absolute border border-solid border-[#e4e4e7] inset-0 pointer-events-none rounded-[4px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.06)]" />
      </div>
    </div>
  );
}